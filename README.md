...
|------|----------|-------------------|--------------|------------------|
| 1 | **Assembly** | Raw syscall | 12,517.85 | 7.99 |
| 2 | **C** | libmicrohttpd | 11,471.76 | 8.72 |
| 3 | **Crystal** | HTTP::Server | 10,946.36 | 9.13 |
| 4 | **Nim** | httpbeast | 10,496.43 | 9.53 |
| 5 | **Rust** | Actix-web | 9,485.32 | 10.54 |
| 6 | **Go** | net/http | 9,044.42 | 11.06 |
| 7 | **C++** | Crow | 7,136.80 | 14.01 |
| 8 | **JavaScript** | Express | 4,540.79 | 22.02 |
| 9 | **TypeScript** | Express | 4,502.08 | 22.21 |
| 10 | **Java** | Spring Boot | 3,768.27 | 26.54 |
| 11 | **Python** | FastAPI + Uvicorn | 2,525.24 | 39.60 |
| 12 | **Kotlin** | Ktor | 2,099.43 | 47.63 |
| 13 | **Ruby** | Sinatra + Puma | 1,559.13 | 64.14 |
