...
|------|----------|-------------------|--------------|------------------|
| 1 | **C** | libmicrohttpd | 10,865.33 | 9.20 |
| 2 | **Nim** | httpbeast | 10,223.63 | 9.78 |
| 3 | **Crystal** | HTTP::Server | 10,032.94 | 9.97 |
| 4 | **Go** | net/http | 9,174.25 | 10.90 |
| 5 | **Rust** | Actix-web | 9,173.47 | 10.90 |
| 6 | **C++** | Crow | 6,931.14 | 14.43 |
| 7 | **TypeScript** | Express | 4,422.78 | 22.61 |
| 8 | **JavaScript** | Express | 4,393.89 | 22.76 |
| 9 | **Java** | Spring Boot | 3,677.20 | 27.20 |
| 10 | **Python** | FastAPI + Uvicorn | 2,438.19 | 41.01 |
| 11 | **Kotlin** | Ktor | 2,353.94 | 42.48 |
| 12 | **Ruby** | Sinatra + Puma | 1,428.54 | 70.00 |
