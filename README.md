...
|------|----------|-------------------|--------------|------------------|
| 1 | **C** | libmicrohttpd | 16,342.89 | 6.12 |
| 2 | **Crystal** | HTTP::Server | 15,246.46 | 6.56 |
| 3 | **Nim** | httpbeast | 14,533.93 | 6.88 |
| 4 | **Rust** | Actix-web | 13,765.67 | 7.26 |
| 5 | **Go** | net/http | 13,219.61 | 7.57 |
| 6 | **C++** | Crow | 10,813.98 | 9.25 |
| 7 | **JavaScript** | Express | 7,437.52 | 13.45 |
| 8 | **TypeScript** | Express | 6,897.14 | 14.50 |
| 9 | **Java** | Spring Boot | 5,647.00 | 17.71 |
| 10 | **Python** | FastAPI + Uvicorn | 3,495.77 | 28.61 |
| 11 | **Kotlin** | Ktor | 2,830.77 | 35.33 |
| 12 | **Ruby** | Sinatra + Puma | 1,943.79 | 51.45 |
